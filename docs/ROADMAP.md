...
### Storage efficiency
- [x] zstd compression
- [x] Content-defined chunking and deduplication (incremental-forever; copy jobs for deduplicated backups are still open)
...
- [x] Plugin system for sources and destinations ([docs/PLUGINS.md](PLUGINS.md))
